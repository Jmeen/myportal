		...
		<div id="wrapper">
			<div id="content">
				...
				<form id="join-form" name="userUpdateForm" action='<c:url value="/users/update"/>' method="POST">
					...
					<input name="name" type="text" placeholder="이름을 입력하십시오" value="${authUser.getName() }">
					...
					<input type="radio" name="gender" value="M" checked='${authUser.getGender() == "M"  }'>
					남성
					</radio>
					<input type="radio" name="gender" value="F" checked='${authUser.getGender() == "F"  }'>
					여성
					</radio>
					<br>
